              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td>
                    ...
                    <p style="color: #6b7280; font-size: 14px; margin: 0 0 28px 0;">A visitor has submitted a message through the CIAS contact form.</p>
          ...
          <tr>
            <td style="padding: 24px 40px; background-color: #f8fafc; border-top: 1px solid #e2e8f0;">
              <p style="color: #64748b; font-size: 12px; margin: 0 0 8px 0; line-height: 1.5;">
                This message was sent from the <strong>MSU-TCTO website</strong> (CIAS contact form).
              </p>
